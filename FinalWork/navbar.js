function navbar(){
   ...
   return ` <div class="main">
    <div id="navbar">
        ...
        <div id="div_search">
            <input   id="nav_searchbar" type="search"  placeholder="Search everything at Walmart online and in store..."
               >
        </div>
        ...
        <div id="div_items">
            <div class="dropDown">
                <button id="btn_item" style="width:110px ;">
        ...
        <div id="div_acc">
            <div class="dropDown">
                <button id="btn_signin" style="width:110px ;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" id="person_svg" height="28"
                ...
                <div class="dropdown-content1">
                    <section id="inner_section">
                        <button id="inner_signBtn"> Sign In</button>
                        <button id="inner_create">Create Acc</button>
                    </section>
                </div>
            </div>
        </div>
        ...
        <div id="div_cart">
            <button id="btn_cart" style="width: 40px; height: 50px; ">
        ...
        <div class="rightDiv">
            <div id="location">
                ...
                <div class="dropDown">
                    ...
                    <button style="width:300px ;height: 20px; ">
                    ...
                    <div class="dropdown-content2">
                        ...
                        <div id="location_finding">
                            ...
                            <div><img src="	https://i5.walmartimages.com/dfw/4ff9c6c9-5249/k2-_71d3c250-050a-40b0-8fd7-c84c1df83204.v1.png" width="16" height="16" alt="">
                                ...
                                <br>
                                <span style="font-weight: 500; font-size:12px;"> Sacramento, CA 95829</span>
                                <br>
...
// let searchWord=document.getElementById("nav_searchBar");

// document.getElementById("nav_searchbar").addEventListener("keypress",fetchData);
...
// console.log("Hello")
    ...
    // console.log(item)
    // localStorage.setItem("SearchItemDisplay",item);
